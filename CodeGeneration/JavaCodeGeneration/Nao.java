...
/* The following code was generated by JavaNaoCodeGenerator on 30/07/11 20:30. */
...
public abstract class Nao {
	...
	private static abstract class ALModule {
		...
		public JSONObject exit() {
			return requestAction("" + this.getClass().getSimpleName()
					+ "/exit/()");
		}
	...
	/**
	 * The ALAudioDevice module allows other modules to access to the sound data
	 * of the nao's microphones, and to send sound toward its loudspeakers The
	 * way to receive or send the audio data depends whether the modules are
	 * local (dynamic library) or remote (executable).
	 */
	...
	/**
	 * This module computes the position (azimuth, elevation) of a sound source
	 * detected by ALSoundDetection.
	 */
	...
	/**
	 * The bonjour module advertises this Nao's IP address on the local network
	 * using the bonjour protocol. See:
	...
	/**
	 * Frame manager is used to play choregraphe projects in naoqi. It needs
	 * Choregraphe projects in input and will return an ID for each project. It
	 * can also only read a given box/timeline in a complex behavior.
	 */
	...
	/**
	 * This module works with Linux Infrared Remote Control (LIRC) in order to
	 * emit/receive IR remotes keys or to emit/receive IR information to/from an
	 * other Nao.
	 */
	...
	/**
	 * ALLandMarkDetection is a module which detects and recognizes Naomarks.
	 * The output value is written in ALMemory in the LandmarkDetected variable.
	 */
	...
	/**
	 * ALlauncher allows to link dynamicaly with library, run executable, unload
	 * library, check if module is loaded...
	 */
	...
	/**
	 * ALLeds contains helper methods for controlling the Light Emiting Devices
	 * (LEDs).
	 */
	...
	/**
	 * This module allows you log errors, warnings, and info to syslog, stdout
	 * or a file. The verbosity level and/or filter allow you to customize the
	 * output.
	 */
	...
	/**
	 * ALMotion provides methods that help make Nao move. It contains commands
	 * for manipulating joint angles, joint stiffness, and a higher level API
	 * for controling walks.
	 */
	...
	/**
	 * ALMotionRecorder is a module giving the possibility to record Nao's
	 * motors poses. A first possibility is to record periodically, ie. a pose
	 * is stored every t seconds. Another possibility is to use an interactive
	 * mode where the user choses when a poses must be stored.
	 */
	...
	/**
	 * ALRedBallDetection is a module which can detect red ball based on color
	 * saturation.
	 */
	...
	/**
	 * Manage robot resources: Synchronize movement, led, sound. Run specific
	 * actions when another behavior wants your resources
	 */
	...
	/**
	 * ALSentinel (ex-ALWatchDog) is a module that implements vital services for
	 * Nao:
	 */
	...
	/**
	 * This module detects in incoming audio buffers every sound with a
	 * significative level.
	 */
	...
	/**
	 * ALSpeechRecognition gives access to the embedded voice recognition
	 * system. It can be dynamically modified. This class allows user to load
	 * the current words list that should be recognized. The result of the
	 * recognition engine is located in the ALMemory's key: "WordRecognized".
	 * The structure of the result is an array: [ (string) word , (float)
	 * confidence ]
	 */
	...
	/**
	 * This module handles the text to speech operations. It converts
	 * std::strings into a PCM signal and sends it into the two speakers. The
	 * voice parameters can be changed using the FX settings.
	 */
	...
	/**
	 * ALVideoDevice, formerly called Video Input Module (V.I.M.), is
	 ...
	 * source, or an access to images transformed in the requested format.
	 */
	...
	/**
	 * ALVisionRecognition is a module which detects and recognizes learned
	 * pictures, like pages of a comic books, faces of objects or even
	 * locations.
	 */
	...
	/**
	 * This module contains different vision functionalities, like picture
	 * taking, video recording, white balance setting, etc ... Picture and
	 * videos are both saved in /home/nao/naoqi/share/naoqi/vision.
	 */
	...
	/**
	 * Manage link with devices (sensors and actuators). See specific
	 * documentation.
	 */
	...
	/**
	 * Factory method for creating a new instance of the Nao module
	 * {@link Nao.ALAudioDevice}.
	 * 
	 * @param ip
	 *            The IP address of the Nao.
	 * @param port
	 ...
	 */
	public static ALAudioDevice createALAudioDevice(final String ip,
			final int port) {
	 ...
	 */
	public static ALAudioPlayer createALAudioPlayer(final String ip,
			final int port) {
	...
	/**
	 * Factory method for creating a new instance of the Nao module
	 * {@link Nao.ALAudioSourceLocalization}.
	 * 
	 * @param ip
	 *            The IP address of the Nao.
	 * @param port
	 ...
	 */
	public static ALAudioSourceLocalization createALAudioSourceLocalization(
	 ...
	 */
	public static ALBehaviorManager createALBehaviorManager(final String ip,
			final int port) {
	 ...
	 */
	public static ALFaceDetection createALFaceDetection(final String ip,
			final int port) {
	 ...
	 */
	public static ALFaceTracker createALFaceTracker(final String ip,
			final int port) {
	 ...
	 */
	public static ALFileManager createALFileManager(final String ip,
			final int port) {
	 ...
	 */
	public static ALFrameManager createALFrameManager(final String ip,
			final int port) {
	 ...
	 */
	public static ALLandMarkDetection createALLandMarkDetection(
			final String ip, final int port) {
	 ...
	 */
	public static ALMotionRecorder createALMotionRecorder(final String ip,
			final int port) {
	 ...
	 */
	public static ALPreferences createALPreferences(final String ip,
			final int port) {
	 ...
	 */
	public static ALPythonBridge createALPythonBridge(final String ip,
			final int port) {
	 ...
	 */
	public static ALRedBallDetection createALRedBallDetection(final String ip,
			final int port) {
	 ...
	 */
	public static ALRedBallTracker createALRedBallTracker(final String ip,
			final int port) {
	 ...
	 */
	public static ALResourceManager createALResourceManager(final String ip,
			final int port) {
	 ...
	 */
	public static ALSoundDetection createALSoundDetection(final String ip,
			final int port) {
	 ...
	 */
	public static ALSpeechRecognition createALSpeechRecognition(
			final String ip, final int port) {
	 ...
	 */
	public static ALTextToSpeech createALTextToSpeech(final String ip,
			final int port) {
	 ...
	 */
	public static ALVideoDevice createALVideoDevice(final String ip,
			final int port) {
	 ...
	 */
	public static ALVisionRecognition createALVisionRecognition(
			final String ip, final int port) {
	 ...
	 */
	public static ALVisionToolbox createALVisionToolbox(final String ip,
			final int port) {
