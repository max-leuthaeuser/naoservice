// Generated for ALSensors version 1.10.22

#ifndef ALSENSORSPROXY_H_
#define ALSENSORSPROXY_H_
#include "alsensorsproxyposthandler.h"
...
{
  private:
    ALPtr<ALSensorsProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALSensorsProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALSensorsProxy(std::string pIP, int pPort);
