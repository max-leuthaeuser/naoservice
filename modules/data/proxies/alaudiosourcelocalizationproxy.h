// Generated for ALAudioSourceLocalization version 1.10.22
...
/// <summary>This module computes the position (azimuth, elevation) of a sound source detected by ALSoundDetection.</summary>
class ALAudioSourceLocalizationProxy
{
  private:
    ALPtr<ALAudioSourceLocalizationProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALAudioSourceLocalizationProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALAudioSourceLocalizationProxy(std::string pIP, int pPort);
