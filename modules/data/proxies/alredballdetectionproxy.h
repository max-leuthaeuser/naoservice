// Generated for ALRedBallDetection version 1.10.22

#ifndef ALREDBALLDETECTIONPROXY_H_
#define ALREDBALLDETECTIONPROXY_H_
#include "alredballdetectionproxyposthandler.h"
...
/// <summary>ALRedBallDetection is a module which can detect red ball based on color saturation.</summary>
class ALRedBallDetectionProxy
{
  private:
    ALPtr<ALRedBallDetectionProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALRedBallDetectionProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALRedBallDetectionProxy(std::string pIP, int pPort);
