// Generated for ALVisionRecognition version 1.10.22

#ifndef ALVISIONRECOGNITIONPROXY_H_
#define ALVISIONRECOGNITIONPROXY_H_
#include "alvisionrecognitionproxyposthandler.h"
...
/// <summary>ALVisionRecognition is a module which detects and recognizes learned pictures, like pages of a comic books, faces of objects or even locations.</summary>
class ALVisionRecognitionProxy
{
  private:
    ALPtr<ALVisionRecognitionProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALVisionRecognitionProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALVisionRecognitionProxy(std::string pIP, int pPort);
