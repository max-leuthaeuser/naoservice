// Generated for ALSonar version 1.10.22
...
/// <summary>Deals with Ultrasonic sound Sensors. Usefull to detect an obstacle.</summary>
class ALSonarProxy
{
  private:
    ALPtr<ALSonarProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALSonarProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALSonarProxy(std::string pIP, int pPort);
