// Generated for ALLandMarkDetection version 1.10.22
...
/// <summary>ALLandMarkDetection is a module which detects and recognizes Naomarks. The output value is written in ALMemory in the LandmarkDetected variable.</summary>
class ALLandMarkDetectionProxy
{
  private:
    ALPtr<ALLandMarkDetectionProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALLandMarkDetectionProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALLandMarkDetectionProxy(std::string pIP, int pPort);
