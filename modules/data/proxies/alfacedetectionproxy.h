// Generated for ALFaceDetection version 1.10.22
...
{
  private:
    ALPtr<ALFaceDetectionProxyImpl> fImpl;
  ...
  public:
    ...
    /// Local Constructor
    /// </summary>
    ALFaceDetectionProxy(ALPtr<ALBroker> pBroker);

    /// <summary>
    /// Remote Constructor
    /// </summary>
    ALFaceDetectionProxy(std::string pIP, int pPort);
    ...
    /// </summary>
    /// <param name="pId"> ID of the person to save </param>
    /// <returns> true if the operation succeeds </returns>
